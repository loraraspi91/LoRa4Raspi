...
{
  return ((uint8_t)readRegister(REG_PKT_SNR_VALUE)) * 0.25;
}
...
void LoRaClass::setSPIFrequency(uint32_t frequency)
{
  ...
  _spi_frequency = frequency;
  wiringPiSPISetupMode (_spi, _spi_frequency, 0);

}

void LoRaClass::dumpRegisters(ostream& out)
{
  for (int i = 0; i < 128; i++) { 
